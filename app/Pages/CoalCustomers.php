...
class CoalCustomers 
{
    public $tabletitle = "Coal Customer Manager";
    public $pageclass = "customers";
    public $pagesection = "utility";
    public $model = 'coalCustomer';
    public $order = 'ASC';
    public $reqdata = true;
    ...
    public $modals = [
        ...
        'delete'    => [
            ...
            'elms'  => [
                [
                    'type'  => 'label',
                    'value' => 'Do you really want to delete the coal customer?',
                ]
            ]
        ]
    ];
